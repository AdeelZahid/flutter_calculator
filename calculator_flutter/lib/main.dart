...
class Calculator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SimpleCalculatr(),
    );
  }
}

class SimpleCalculatr extends StatefulWidget {
  @override
  _SimpleCalculatrState createState() => _SimpleCalculatrState();
}

class _SimpleCalculatrState extends State<SimpleCalculatr> {
  String equation = "0";
  String result = "0";
  String expression = "";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Andropple Calculator'),
        centerTitle: true,
      ),
      body: Column(
        children: [
